...
import RepresentationRequestForm from "../features/franchise/RepresentationRequestForm";
import Advice from "../features/franchise/Advice";
import OptionItem from "../features/franchise/OptionItem";
...
// Styles
import { bannerImgStyle, bannerTitleStyle } from "./About";
...
function BranchApply() {
  ...
  return (
    <div className="mb-6 md:mb-12">
      ...
      <div className={containerStyle}>
        <div className="mt-6 rounded-lg border border-[#CBCBCB] px-3 py-4 md:mt-12 md:px-6 md:py-8">
