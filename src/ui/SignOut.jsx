...
// Actions
// import { setLoginStatus } from "../../New folder/src/components/redux/auth/authActions";
...
import {
  ...
  dialogButtonStyle,
} from "../../New folder/src/components/shopping-cart/ShopCart";
            ...
            >
              <Dialog.Panel className={dialogPanelStyle}>
                ...
                <div className={dialogButtonDivStyle}>
                  <button
                    onClick={closeModal}
                    className={`${dialogButtonStyle} border-[#417F56] bg-[#417F56] text-white`}
                  >
                    بازگشت
                  </button>
                  <button
