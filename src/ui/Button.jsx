...
const buttonStyle =
  "flex items-center text-xs p-3  md:text-sm lg:text-base justify-center gap-x-2 text-[#417F56] border mt-2 border-[#417F56] rounded h-7 sm:h-8   md:h-[2.5em] lg:w-[11.5em]";
