...
import SelectBranchCard from "../features/branches/SelectBranchCard";
    ...
    <>
      ...
      >
        ...
        >
          ...
          <a href={branchId !== undefined ? `/menu/${branchId}` : "#branches"} >
